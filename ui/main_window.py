...
class GameVaultWindow(ctk.CTk):
    ...
    def _create_game_button(self, game: Dict[str, Any]):
        ...
        # Developer
        developer_text = game.get("developer") or "Custom game"
        dev = ctk.CTkLabel(
            text_stack,
            text=developer_text,
    ...
    def _build_game_view(self, game: Dict[str, Any]):
        ...
        backups_inner = ctk.CTkFrame(backups_frame, fg_color="transparent")
        backups_inner.pack(fill="both", expand=True, padx=8, pady=8)
    ...
    def _backup_game(self, game: Dict[str, Any]):
        ...
        ctk.CTkLabel(
            progress_body,
            text=f"Backing up {game.get('name')}...",
            font=ui_font(size=13),
            text_color=BRAND_COLORS["text_secondary"]
        ).pack()
